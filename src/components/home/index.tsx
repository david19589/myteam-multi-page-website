  ...
  return (
    <div className="flex flex-col justify-center">
      <div className="flex flex-col items-center h-[25.44rem] px-[1.5rem] bg-[url('/src/assets/bg-pattern-home-2.svg')] bg-no-repeat bg-bottom">
        <h1 className="md:text-[4rem] md:leading-[3.5rem] md:max-w-[21rem] text-[2.5rem] leading-[2.5rem] font-[700] max-w-[15rem] text-center text-[#FFF] mb-[1.2rem]">
          Find the best <span className="text-[#F67E7E]">talent</span>
        </h1>
        <p className="md:max-w-[31rem] text-[1rem] leading-[1.8rem] font-[600] max-w-[22rem] text-center text-[#FFF]">
          Finding the right people and building high performing teams can be
          hard. Most companies aren’t tapping into the abundance of global
          talent. We’re about to change that.
        </p>
      </div>
      <div className="flex flex-col bg-[#012F34] bg-[url('/src/assets/bg-pattern-home-3.svg')] bg-no-repeat bg-[right_top]">
        <div className="md:pl-[6rem] pt-[4rem] mb-[3.5rem] pl-[1.5rem]">
          <span className="flex h-[0.25rem] w-[3.13rem] bg-[#F67E7E] mb-[2rem]"></span>
          <h1 className="md:max-w-[27rem] text-[2rem] leading-[2rem] font-[700] max-w-[13rem] text-start text-[#FFF]">
            Build & manage distributed teams like no one else.
          </h1>
        </div>
        <div className="md:flex md:flex-col md:items-center mb-[4rem]">
          {infoData.map((item, index) => (
            <div
              key={index}
              className="md:flex-row flex flex-col items-center mb-[3rem] px-[1.5rem]"
            >
              <img
              ...
              <div className="md:items-start flex flex-col items-center gap-[0.5rem]">
                ...
                <p className="md:text-start text-[0.94rem] leading-[1.563rem] font-[600] max-w-[21rem] text-center text-[#FFF] opacity-[80%]">
                  {item.paragraph}
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-col items-center bg-[#004047] pt-[8.8rem] bg-[url('/src/assets/bg-pattern-home-4-about-3.svg')] bg-no-repeat bg-[left_top]">
        <h1 className="md:max-w-[31rem] text-[2rem] leading-[2rem] font-[700] max-w-[20rem] px-[1.5rem] text-center text-[#FFF] mb-[5.25rem]">
      ...
      <div className="md:flex-row md:justify-center md:gap-[5.5rem] flex flex-col items-center pt-[5rem] pb-[7rem] px-[1.5rem] bg-[#F67E7E] bg-[url('/src/assets/bg-pattern-home-6-about-5.svg')] bg-no-repeat bg-[left_bottom]">
        <h1 className="md:mb-0 text-[2rem] leading-[2rem] font-[700] text-[#012F34] text-center mb-[1.5rem]">
